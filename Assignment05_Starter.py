...
# BLee,11.16.2019,Added code to complete assignment 5
# ------------------------------------------------------------------------ #
...
while (True):
    ...
    # Step 4 - Add a new item to the list/Table
        ...
        strTask = input("Enter Name of Task: ")
    ...
    # Step 5 - Remove a new item to the list/Table
        ...
        for objRow in lstTable:
            print(objRow["Task"] + ", " + objRow["Priority"])
        print()
        strTaskDelete = input("Enter the task name you would like to remove: ")
        for row in lstTable:
            if strTaskDelete in row["Task"]:
                print()
